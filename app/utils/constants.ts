export const STACK_ITEMS: StackItem[] = [
  {
    name: "TypeScript",
    description: "index.stack.items.0.description",
    icon: "simple-icons:typescript",
    url: "https://www.typescriptlang.org",
  },
  {
    name: "Node.js",
    description: "index.stack.items.1.description",
    icon: "simple-icons:nodedotjs",
    url: "https://nodejs.org",
  },
  {
    name: "Vue.js",
    description: "index.stack.items.2.description",
    icon: "simple-icons:vuedotjs",
    url: "https://vuejs.org",
  },
  {
    name: "Nuxt",
    description: "index.stack.items.3.description",
    icon: "simple-icons:nuxt",
    url: "https://nuxtjs.org",
  },
  {
    name: "Tailwind",
    description: "index.stack.items.4.description",
    icon: "simple-icons:tailwindcss",
    url: "https://tailwindcss.com",
  },
  {
    name: "Prisma",
    description: "index.stack.items.5.description",
    icon: "simple-icons:prisma",
    url: "https://prisma.io",
  },
  {
    name: "PostgreSQL",
    description: "index.stack.items.6.description",
    icon: "simple-icons:postgresql",
    url: "https://www.postgresql.org",
  },
  {
    name: "Go",
    description: "index.stack.items.7.description",
    icon: "simple-icons:go",
    url: "https://go.dev",
  },
  {
    name: "Git",
    description: "index.stack.items.8.description",
    icon: "simple-icons:git",
    url: "https://git-scm.com",
  },
  {
    name: "Docker",
    description: "index.stack.items.9.description",
...
export const PROJECT_ITEMS: ProjectItem[] = [
  {
    ...
    stack: ["TypeScript", "Nuxt", "Vue.js", "Tailwind", "Go", "OAuth", "Prisma", "PostgreSQL", "Redis"],
  ...
  },
  {
    ...
    stack: ["TypeScript", "Nuxt", "Vue.js", "Tailwind", "Chart.js", "OAuth", "Prisma", "PostgreSQL", "Redis"],
