	...
	return (
		<div id="hero" className="card-shadow relative flex min-h-screen items-center justify-center">
			...
			<div className="relative flex flex-col items-center p-4 text-center font-serif">
				...
				<p className="max-w-lg text-xl">{t("description")}</p>

				<hr />

				<div className="flex items-center justify-center gap-4 text-secondary">
					<Link href="https://github.com/matimortari" aria-label={t("github")}>
						<Icon icon="simple-icons:github" className="icon size-8 md:size-6" />
					</Link>
					<Link href="https://linkedin.com/in/matheus-mortari-19rt/" aria-label={t("linkedin")}>
						<Icon icon="simple-icons:linkedin" className="icon size-8 md:size-6" />
					</Link>
					<Link href="mailto:matheus.felipe.19rt@gmail.com" aria-label={t("gmail")}>
						<Icon icon="simple-icons:gmail" className="icon size-8 md:size-6" />
					</Link>
				</div>
			</div>
		</div>
