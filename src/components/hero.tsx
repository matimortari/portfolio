import hero from "@/src/json/hero.json"
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative flex min-h-screen items-center justify-center">
      ...
      <div className="hero-map animate-scroll absolute inset-x-0 bottom-0 z-0 overflow-hidden opacity-20">
        <Image src="/map.png" alt="Background Image" className="hidden size-full md:block" width={800} height={800} />
        <Image src="/map.png" alt="Background Image" className="hidden size-full md:block" width={800} height={800} />
      </div>
      ...
      <div className="relative flex flex-col items-center gap-4 p-16">
        ...
        >
          <Image src="/avatar.png" alt="Avatar" priority={true} fill className="animate-float avatar" />
        </motion.div>
        ...
        <motion.div
          ...
          className="m-4 flex flex-col gap-4 text-center"
        >
